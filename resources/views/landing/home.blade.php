        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('register') }}" class="bg-white text-sibali-blue px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
                        Daftar Sekarang
                    </a>
                    <a href="{{ route('programs') }}" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-sibali-blue transition">
                        Lihat Program
                    </a>
                </div>
            </div>
    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center">
                <div class="text-4xl font-bold text-sibali-blue mb-2">{{ number_format($stats['total_students']) }}+</div>
                <div class="text-gray-600">Siswa Aktif</div>
            </div>
            <div class="text-center">
                <div class="text-4xl font-bold text-sibali-blue mb-2">{{ number_format($stats['total_classes']) }}+</div>
                <div class="text-gray-600">Kelas Tersedia</div>
            </div>
            <div class="text-center">
                <div class="text-4xl font-bold text-sibali-blue mb-2">{{ number_format($stats['total_teachers']) }}+</div>
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-2xl font-bold text-sibali-blue">{{ format_currency($program->price) }}</span>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-2">{{ $program->name }}</h3>
                    <p class="text-gray-600 mb-4">{{ $program->description }}</p>
                    <div class="space-y-2 mb-6">
                        <div class="flex items-center text-sm text-gray-600">
                            <svg class="w-5 h-5 mr-2 text-sibali-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('program.detail', $program->slug) }}" class="block w-full text-center bg-sibali-blue text-white py-2 rounded-lg hover:bg-sibali-maroon transition">
                        Lihat Detail
                    </a>
                </div>
            </div>
        ...
        <div class="text-center mt-12">
            <a href="{{ route('programs') }}" class="inline-block bg-sibali-maroon text-white px-8 py-3 rounded-lg font-semibold hover:bg-sibali-red transition">
                Lihat Semua Program
            </a>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-50 rounded-lg p-6 shadow hover:shadow-lg transition">
                ...
                <div class="flex items-center">
                    <div class="w-10 h-10 bg-sibali-sky rounded-full flex items-center justify-center text-sibali-blue font-bold mr-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <article class="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition">
                ...
                <div class="p-6">
                    ...
                    <a href="{{ route('blog.show', $post->slug) }}" class="text-sibali-blue hover:text-sibali-maroon font-semibold">
                        Baca Selengkapnya →
                    </a>
                </div>
            </article>
...
<section class="py-16 bg-gradient-to-r from-sibali-blue to-sibali-maroon text-white">
    <div class="container mx-auto px-4 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <a href="{{ route('contact') }}" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-sibali-blue transition">
                Hubungi Kami
            </a>
        </div>
    </div>
