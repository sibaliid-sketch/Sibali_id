...
@section('title', 'Reset Password - Sibali.id')
            ...
            <form class="mt-8 space-y-6" method="POST" action="{{ route('password.update') }}">
                ...
                <div>
                    ...
                    <input id="password" name="password" type="password" autocomplete="new-password" required
                        class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-sibali-blue focus:border-sibali-blue focus:z-10 sm:text-sm @error('password') border-red-300 @enderror"
                ...
                <div>
                    ...
                    <input id="password_confirmation" name="password_confirmation" type="password"
                        ...
                        class="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-sibali-blue focus:border-sibali-blue focus:z-10 sm:text-sm @error('password_confirmation') border-red-300 @enderror"
